...
@rx.page(route="/template1/[item_id]")
                ...
                rx.drawer.content(
                    rx.scroll_area(
                        rx.flex(
                            ...
                            rx.cond(
                                ((EditorState.currentKey) == "bodySection1Img")
                                | ((EditorState.currentKey) == "bodySection2Img")
                                | ((EditorState.currentKey) == "bodySection3Img")
                                | ((EditorState.currentKey) == "heroImg"),
                                rx.box(image_grid()),
                                rx.cond(
